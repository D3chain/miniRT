...
#    Updated: 2026/01/08 05:10:49 by echatela         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
RUN_SRC		:=	run_scene.c event.c ray_hit.c ray_hit_sphere.c ray_hit_cylinder.c ray_hit_plane.c ray_hit_cone.c draw_pixel_to_img.c util/closest_hit_dst.c 
