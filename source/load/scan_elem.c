...
int	parse_pl(struct s_app *app, const char *line, int *i_elem)
{
	...
	randomize_material(&app->scene.elems[*i_elem].u.plane.material);
...
int	parse_sp(struct s_app *app, const char *line, int *i_elem)
{
	...
	randomize_material(&app->scene.elems[*i_elem].u.sphere.material);
...
int	parse_cy(struct s_app *app, const char *line, int *i_elem)
{
	...
	randomize_material(&app->scene.elems[*i_elem].u.cylinder.material);
