...
/*   Updated: 2026/01/07 13:39:46 by echatela         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	complete_co(struct s_app *app, struct s_elem *elem)
{
	...
	cone = &elem->u.cone;
	cone->p1 = project(cone->coord, mul3(cone->axis, -1.0), cone->height / 2);
	cone->p2 = project(cone->coord, cone->axis, cone->height / 2);
