...
t_color	color_add(t_color color1, t_color color2)
{
	...
	col.s_rgb.r = fmin(255.0, color1.s_rgb.r + color2.s_rgb.r);
	col.s_rgb.g = fmin(255.0, color1.s_rgb.g + color2.s_rgb.g);
	col.s_rgb.b = fmin(255.0, color1.s_rgb.b + color2.s_rgb.b);
	col.s_rgb.t = 255.0;
	return (col);
}
